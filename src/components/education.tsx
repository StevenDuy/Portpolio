      ...
      <div className="container px-4 md:px-6 mx-auto max-w-4xl">
        ...
        <div className="relative border-l border-border ml-3 md:ml-6 space-y-12">
          ...
          >
            ...
            <Card className="border-border/50 bg-card/50 hover:bg-card hover:border-primary/30 transition-colors">
              <CardContent className="p-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 space-y-2 md:space-y-0">
                  <div>
                    <h3 className="text-xl font-bold text-foreground">BTEC Higher National Diploma in Information Technology</h3>
                ...
                <div className="mt-6 pt-6 border-t border-border/50">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <span className="px-3 py-1 rounded-md bg-secondary/10 text-secondary border border-secondary/20 text-sm">
                      Vietnamese
                    </span>
                    <span className="px-3 py-1 rounded-md bg-primary/10 text-primary border border-primary/20 text-sm">
                      English
                    </span>
                  </div>
                </div>
